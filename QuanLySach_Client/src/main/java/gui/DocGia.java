...
public class DocGia extends JPanel implements ActionListener{
	...
	public DocGia() {
		...
		btnTim.setIcon(new ImageIcon(DocGia.class.getResource("/img/search (1).png")));
...
//		table_1 = new JTable();
		...
		btnDau_1_1_1.setIcon(new ImageIcon(DocGia.class.getResource("/img/previousEnd.png")));
		btnDau_1_1_1.setFont(new Font("Arial", Font.PLAIN, 16));
		
		JButton btnDau_2_1 = new JButton("");
		btnDau_2_1.setIcon(new ImageIcon(DocGia.class.getResource("/img/rewind-button.png")));
		...
		btnDau_1_1.setIcon(new ImageIcon(DocGia.class.getResource("/img/nextbutton.png")));
		btnDau_1_1.setFont(new Font("Arial", Font.PLAIN, 16));
		
		JButton btnDau_2 = new JButton("");
		btnDau_2.setIcon(new ImageIcon(DocGia.class.getResource("/img/nextEnd.png")));
	...
	public static void main(String[] args) {
		JFrame f = new JFrame();
		f.setSize(1920,918);
		f.getContentPane().add(new DocGia());
		f.setVisible(true);
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(object.equals(btnDangKy)) {
			...
			new SuaDocGiaDialog2("Chinh").setVisible(true);
		}
